...
class BillingInfoDialogAdapter(private val context: Context, private val list: List<Country>): RecyclerView.Adapter<BillingInfoDialogAdapter.CardViewDesignThingsHolder>() {
    ...
    override fun onBindViewHolder(holder: CardViewDesignThingsHolder, position: Int) {
        ...
        holder.tvRowText?.text = text.country
