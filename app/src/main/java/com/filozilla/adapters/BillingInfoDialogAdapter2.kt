...
class BillingInfoDialogAdapter2(private val context: Context, private val list: List<City>): RecyclerView.Adapter<BillingInfoDialogAdapter2.CardViewDesignThingsHolder>() {
    ...
    override fun onBindViewHolder(holder: CardViewDesignThingsHolder, position: Int) {
        ...
        holder.tvRowText?.text = text.city
